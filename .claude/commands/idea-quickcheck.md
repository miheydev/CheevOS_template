...
Быстрая прогонка бизнес-идеи через 3 экспертов за один раунд. Лайт-версия `/business-advisory-team` — для случаев, когда нужна быстрая проверка, а не глубокий анализ.
...
**Стоит ли копать глубже?** [Да → используй /business-advisory-team / Нет / Только если ...]
```
...
4. **Если идея интересная** — предложи запустить полный `/business-advisory-team`.
5. **Язык агентов — английский.** Синтез — на русском.
