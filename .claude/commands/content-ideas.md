...
- **Канал** (если указан): tg, aaa-blog, aip — влияет на формат и глубину
...
### Шаг 5 (опционально): Сохранить

Если пользователь просит — сохрани в `<project>/Brand/Content/Ideas/ideas-YYYY-MM-DD-[slug].md` (или аналогичный путь в твоей структуре).
...
5. **Если пользователь выбрал идею** — предложи следующий шаг: `/content-pipeline` с выбранной темой.
