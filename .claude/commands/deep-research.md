...
Сохрани результат в файл. Выбор папки — по контексту проекта, например:
- Рабочий контекст → `<work-project>/Docs/Research/`
- Личное/финансы → `<knowledge-base>/Knowledge/`
- Общее → `<knowledge-base>/Knowledge/References/`
- Имя файла: `Research-[Тема]-YYYY-MM-DD.md`
...
3. **Актуальность.** При поиске добавляй текущий год (2026) для получения свежих данных.
